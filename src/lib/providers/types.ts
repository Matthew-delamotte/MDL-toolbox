...
export interface LeadContext { company: CompanyInput; contact?: ContactInput | null; opportunity?: {title: string; description: string; budgetMin?: number | null; budgetMax?: number | null} | null; research?: ResearchFact[]; detectedProblems?: string[]; totalScore?: number }
